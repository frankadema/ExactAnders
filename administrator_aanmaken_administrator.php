    ...
    else
    {
      ...
      <div class="row content">
        <div class="col-lg-12 center">
          <?php
          echo"<h1>Administrator toevoegen</h1>";
          $form_verstuurd = 0;
          if(isset($_POST['submit']))
          {
            ...
            else
            {
              if($_POST['password'] === $_POST['password2'])
              {
                ...
                $sql = "INSERT INTO tech_ExactAnders.administrator (firstname, lastname, email, password, username)
                VALUES ('$firstname','$lastname','$email','$password','$username')";
                if ($conn->query($sql) === TRUE)
                {
                  echo "Administrator is toegevoegd aan database, u wordt terug getstuurd naar de startpagina";
                  echo '<meta http-equiv="refresh" content="2;url=administrator_aanmaken_administrator.php">';
                }
                else
                {
